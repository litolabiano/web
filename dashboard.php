    ...
    <div class="main-content">
        ...
        <header class="dashboard-header">
            <div class="container" style="position: relative; z-index: 2; text-align: center;">
                <h1>Welcome to Your KLD Dashboard</h1>
                <p>Manage your jobs, track earnings, and grow your freelance business.</p>
            </div>
        </header>
        ...
        <section class="chart-container">
            <h3 style="color: var(--kld-green); margin-bottom: 20px;">Earnings Overview</h3>
            <div class="bar-chart">
                <div class="bar">
        ...
        <!-- Recent Jobs Section -->
        <section>
            <h3 style="color: var(--kld-green); margin-bottom: 20px;">Recent Jobs</h3>
            <div class="jobs-grid">
                <div class="job-card">
                    <div class="card-body">
                        <h5 class="card-title">Web Development Project</h5>
                        <p class="card-text">Build a responsive e-commerce site using React and Node.js. Requirements include payment integration and admin panel.</p>
                        <div class="card-footer">
                            <i class="fas fa-clock"></i> Due in 3 days | $1,200
                        </div>
                    </div>
                </div>
                <div class="job-card">
                    <div class="card-body">
                        <h5 class="card-title">Graphic Design for Branding</h5>
                        <p class="card-text">Create logo, business cards, and social media assets for a startup. Modern, minimalist style preferred.</p>
                        <div class="card-footer">
                            <i class